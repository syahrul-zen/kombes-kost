                    ...
                    <tbody>
                        @foreach ($bookings as $booking)
                            <tr>
                                ...
                                <td><span
                                        class="badge rounded-pill {{ $booking->status_pembayaran == 'pending' ? 'bg-warning' : 'bg-success' }} text-dark">{{ $booking->status_pembayaran }}</span>
                                </td>
                                <td><span
                                        class="badge rounded-pill {{ $booking->status_booking == 'pending' ? 'bg-warning' : 'bg-success' }} text-dark">{{ $booking->status_pembayaran }}</span>
                                </td>
