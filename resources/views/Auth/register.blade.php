...
<html lang="id">
    ...
    <head>
        ...
        <title>Registrasi Member - Kombes Kost</title>
        ...
        <div class="registration-container">
            <div class="registration-card">
                <div class="registration-header">
                    ...
                    <p>Bergabunglah dengan Kombes Kost dan nikmati kemudahan menyewa kost</p>
                </div>
                    ...
                    <form action="{{ url("register") }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" value="{{ @old("foto") }}" name="foto"
                                id="foto" required accept="image/jpeg,image/png">
                            @error("foto")
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
