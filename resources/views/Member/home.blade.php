            ...
            <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img src="https://picsum.photos/seed/kost1/1920/800" class="d-block w-100"
                            alt="Pink Residence 1">
                        <div class="carousel-overlay"></div>
                        <div class="carousel-caption d-none d-md-block">
                            <div class="hero-content">
                                <h1 data-aos="fade-right">Selamat Datang di <span>Pink Residence</span></h1>
                                <p class="subtitle" data-aos="fade-right" data-aos-delay="200">Hunian modern dan nyaman
                    ...
                    <div class="carousel-item">
                        <img src="https://picsum.photos/seed/kost2/1920/800" class="d-block w-100"
                            alt="Pink Residence 2">
                        <div class="carousel-overlay"></div>
                        <div class="carousel-caption d-none d-md-block">
                            <div class="hero-content">
                                <h1 data-aos="fade-right">Fasilitas <span>Lengkap</span></h1>
                                <p class="subtitle" data-aos="fade-right" data-aos-delay="200">WiFi gratis, AC, laundry,
                    ...
                    <!-- Slide 3 -->
                    <div class="carousel-item">
                        <img src="https://picsum.photos/seed/kost3/1920/800" class="d-block w-100"
                            alt="Pink Residence 3">
                        <div class="carousel-overlay"></div>
                        <div class="carousel-caption d-none d-md-block">
                            <div class="hero-content">
                    ...
                    <!-- Slide 4 -->
                    <div class="carousel-item">
                        <img src="https://picsum.photos/seed/kost4/1920/800" class="d-block w-100"
                            alt="Pink Residence 4">
                        <div class="carousel-overlay"></div>
                        <div class="carousel-caption d-none d-md-block">
                            <div class="hero-content">
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="about-content">
                        ...
                        <p>Terletak di lokasi yang sangat strategis, Pink Residence memberikan kemudahan akses ke
                            berbagai fasilitas umum seperti kampus, perkantoran, pusat perbelanjaan, dan transportasi
                            publik.</p>
