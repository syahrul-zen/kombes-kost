...
<body>
    ...
    <div class="payment-header">
        ...
        <!-- Back Button -->
        <a href="pesan-kamar.html" class="back-button" title="Kembali">
    ...
    <div class="container payment-container">
        ...
        <div class="success-message" id="successMessage">
            <i class="bi bi-check-circle-fill"></i> Pembayaran berhasil! Kami akan memverifikasi bukti pembayaran Anda
            dalam 1x24 jam.
        </div>
        ...
        <div class="order-summary">
            ...
            <div class="order-details">
                <div class="order-item">
                    ...
                    <div class="order-value">#PK202412001</div>
                </div>
                <div class="order-item">
                    <div class="order-label">Tipe Kamar</div>
                    <div class="order-value" id="roomType">Kamar Deluxe</div>
                </div>
                <div class="order-item">
                    <div class="order-label">Check-in</div>
                    <div class="order-value" id="checkInDate">15 Desember 2024</div>
                </div>
                <div class="order-item">
                    <div class="order-label">Check-out</div>
                    <div class="order-value" id="checkOutDate">15 Januari 2025</div>
                </div>
                <div class="order-item">
                    <div class="order-label">Durasi</div>
                    <div class="order-value" id="duration">31 hari</div>
                </div>
                <div class="order-item">
                ...
                <div class="order-item">
                    ...
                    <div class="order-value" id="totalPayment">Rp 1.300.000</div>
                </div>
            </div>
        </div>
        ...
        <div class="payment-button-container">
            <button type="button" class="btn-confirm-payment" id="confirmPayment">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            const paymentInstructions = {
                transfer: [{
                        title: "Transfer ke Rekening Pink Residence",
                        description: "Silakan transfer ke nomor rekening berikut:"
                    },
                    {
                        title: "Nomor Rekening",
                        description: "BCA: 123-456-7890 a.n. Pink Residence"
                    },
                    {
                ...
                qris: [{
                        title: "Scan QR Code",
                        description: "Scan QR Code yang tersedia di halaman konfirmasi"
                    },
                    {
                        title: "Selesaikan Pembayaran",
                        description: "Ikuti instruksi di aplikasi e-wallet Anda"
                    },
                    {
                        title: "Upload Bukti",
                        description: "Upload bukti pembayaran QRIS Anda"
                    }
                ],
                ewallet: [{
                        title: "Pilih E-Wallet",
                        description: "Pilih GoPay, OVO, Dana, atau ShopeePay"
                    },
                    {
                        title: "Masukkan Nomor",
                        description: "Masukkan nomor HP terdaftar Pink Residence"
                    },
                    {
                        title: "Selesaikan Pembayaran",
                        description: "Ikuti instruksi di aplikasi e-wallet"
                    }
                ],
                minimarket: [{
                        title: "Kunjungi Minimarket",
                        description: "Datang ke Indomaret, Alfamaret, atau minimarket terdekat"
                    },
                    {
                        title: "Sebutkan Kode Pembayaran",
                        description: "Sebutkan kode pembayaran Pink Residence ke kasir"
                    },
                    {
                        title: "Bayar Tunai",
                        description: "Bayar sesuai total pembayaran dan simpan struk"
                    }
                ]
            };
