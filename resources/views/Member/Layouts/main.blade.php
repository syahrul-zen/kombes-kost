        ...
        <footer>
            <div class="container">
                        ...
                        <div class="footer-widget">
                            ...
                            <ul class="contact-info">
                                ...
                                <li>
                                    ...
                                    <span>kombeskost@gmail.com</span>
                                </li>
                                <li>
                                    <i class="bi bi-geo-alt"></i>
                                    <span>Blk. Q No.41, Mendalo Darat, Kec. Jambi Luar Kota, Kabupaten Muaro Jambi,
                                        Jambi 3636</span>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="text-center">
                    <p class="mb-0">&copy; 2025 Kombes Kost. All rights reserved.</p>
                </div>
            </div>
        </footer>
