                    ...
                    <div class="order-item">
                        ...
                        <div class="order-value">
                            ...
                            @if ($booking->status_booking == "pending")
                                <span class="order-status bg-warning text-white">{{ $booking->status_booking }}</span>
                            @elseif($booking->status_booking == "confirmed")
                                <span class="order-status bg-success text-white">{{ $booking->status_booking }}</span>
                            @elseif ($booking->status_booking == "check_in")
                                <span class="order-status bg-primary text-white">{{ $booking->status_booking }}</span>
                            @else
                                <span
                                    class="order-status bg-secondary text-white">{{ $booking->status_booking }}</span>
                            @endif
                        </div>
                    </div>
                    <div class="order-item">
                        ...
                        <div class="order-value">
                            ...
                            @if ($booking->status_pembayaran == "pending")
                                <span
                                    class="order-status bg-warning text-white">{{ $booking->status_pembayaran }}</span>
                            @else
                                <span class="order-status bg-success">{{ $booking->status_pembayaran }}</span>
                            @endif
